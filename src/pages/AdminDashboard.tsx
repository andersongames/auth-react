...
export default function AdminDashboard() {
  return (
    <div className="min-h-screen space-y-6 flex flex-col items-center justify-center text-center p-6 bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
      <div>
